...
const systemPrompt = (lang: string) =>
  ...
  'Пиши коротко, живо, без канцелярита и без выдуманных фактов. В blurb НЕ повторяй название товара и цену — они уже видны в карточке; пиши только пользу для этого пользователя.'
